    ...
    <>
      <div className="Navbar">
        ...
        <div className="nav-btn">
          ...
          <button type="" className="member-btn">
            Become a member
          </button>
        </div>

        <div className="mobile-nav">
          <a href="#" id="search_img">
            <img id="mobile-nav-li" src={search_img} alt="on Loading" />
          </a>
          <a href="#" id="shopping_img">
            <img id="mobile-nav-li" src={shopping_img} alt="on Loading" />
          </a>
          <a href="#" id="hamburger_img" onClick={mobileNav_on}>
            <img id="mobile-nav-li" src={hamburger_img} alt="on Loading" />
          </a>
        </div>
      </div>
    </>
